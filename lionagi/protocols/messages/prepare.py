...
# NOTE: This module is promoted from lionagi/beta/core/message/prepare_msg.py.
# It retains several beta-specific imports that cannot be cleanly resolved without
# further refactoring of the beta message type hierarchy:
#   - lionagi.beta.core.base.pile.Pile (beta Pile, not protocols Pile)
#   - .role.RoledContent (beta dataclass hierarchy)
#   - .action.ActionRequest / ActionResponse (beta message types)
#   - .assistant.Assistant (beta message type)
#   - .instruction.Instruction (beta Instruction, not protocols Instruction)
#   - .system.System (beta System type)
# These dependencies are noted for future promotion work.
...
from lionagi.beta.core.base.pile import Pile  # TODO: promote to protocols Pile
from lionagi.protocols.generic.progression import Progression

from .action import ActionRequest, ActionResponse  # beta types
from .assistant import Assistant  # beta type
from .instruction import Instruction  # beta type
from .role import RoledContent  # beta type
from .system import System  # beta type
