...
async def _run_fanout(
    ...
    *,
    ...
    orc_imodel = build_imodel_from_spec(
        model_spec, yolo=yolo, verbose=verbose,
        effort_override=effort, theme=theme,
    )
    ...
    for i, a in enumerate(agents):
        ...
        worker_imodel = build_imodel_from_spec(
            worker_model, yolo=yolo, verbose=verbose,
            effort_override=effort, theme=theme,
        )
...
def add_orchestrate_subparser(subparsers: argparse._SubParsersAction) -> None:
    ...
    fo.add_argument(
        "--workers", metavar="M1,M2,...", default=None,
    ...
    fo.add_argument(
        "--with-synthesis", nargs="?", const=True, default=False, metavar="MODEL",
