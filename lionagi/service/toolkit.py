...
from lionagi.service.backend import Normalized, ResourceConfig
from lionagi.service.resource import Service, add_service, list_services_sync
    ...
    def tool_schemas(
        ...
        *,
        ...
        if branch is not None:
            from lionagi.session.constraints import scope_in_resources
