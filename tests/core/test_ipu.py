...
"""Tests for lionagi.core.ipu: invariants and IPU implementations."""
...
from lionagi.core.types import Observation, Principal
...
class TestLatencyBound:
    ...
    def test_post_within_budget_returns_true(self):
        ...
        from lionagi.core.wrappers import WithTimeout
...
class TestLenientIPU:
    ...
    def test_on_observation_logs_debug(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="lionagi.core.ipu"):
