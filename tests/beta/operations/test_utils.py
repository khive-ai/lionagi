...
from lionagi.beta.operations.utils import ReturnAs, handle_return
...
class TestHandleReturn:
    ...
    def test_message_calls_parse_to_assistant_message(self):
        ...
        with pytest.MonkeyPatch().context() as m:
            ...
            m.setattr(
                "lionagi.beta.operations.utils.parse_to_assistant_message",
                mock_parse,
                raising=False,
            )
            # patch within the module's import
            import lionagi.beta.operations.utils as utils_mod
