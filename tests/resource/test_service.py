...
"""
Tests for lionagi.service.resource — Service, ServiceCalling, registry functions,
...
from lionagi.service.resource import (
    ResourceMeta,
    Service,
    ServiceCalling,
    _ResourceDecl,
...
class TestServiceEvaluatePolicy:
    async def test_default_policy_allows(self):
        ...
        from lionagi.service.resource import ResourceMeta
        from lionagi.ln.types import Operable
