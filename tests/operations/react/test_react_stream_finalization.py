...
@pytest.mark.asyncio
async def test_analysis_without_planned_actions_field():
    """ReActAnalysis no longer carries planned_actions; ReAct should still
    complete on a minimal analysis with no actions."""
    branch = make_mocked_branch_for_react()
