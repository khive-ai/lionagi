...
from lionagi.fields.template import FieldMeta, FieldTemplate, ValidationError
...
class TestEdgeCases:
    ...
    def test_field_meta_hash_with_callable(self):
        ...
        from lionagi.fields.template import FieldMeta
    ...
    def test_materialize_cache_eviction_race_condition(self):
        ...
        from lionagi.fields.template import (
            _MAX_CACHE_SIZE,
            FieldTemplate,
            _annotated_cache,
        )
        ...
        try:
            ...
            import lionagi.fields.template

            lionagi.fields.template._MAX_CACHE_SIZE = 2
            ...
            lionagi.fields.template._MAX_CACHE_SIZE = original_size
            _annotated_cache.clear()
